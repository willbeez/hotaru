    ...
    <div class="media-body">
        ...
        <div class="show_post_title media-heading">
            <?php if (!$h->vars['editorial']) { ?> 
                <a data-bind='text: post_title' href='<?php echo $h->post->origUrl; ?>' <?php echo $h->vars['target']; ?> class="click_to_source" rel="nofollow"><?php echo html_entity_decode($h->post->title); ?></a>
            <?php } else { ?>
                <span data-bind='text: post_title'><?php echo html_entity_decode($h->post->title); ?></span>
            <?php } ?>
