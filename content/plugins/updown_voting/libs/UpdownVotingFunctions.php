<?php
/**
 * file: plugins/updown_voting/libs/UpdownVotingFunctions.php
...
class UpdownVotingFunctions
{
    ...
    function vote($h, $post_id, $vote_rating, $user_ip, $undo, $updown_voting_settings) {
        ...
        if ($voted && ($voted < 0) && ($vote_rating > 0)) { 
            $this->updown_voting_remove_vote($h, $post_id, $user_id, $voted, $vote_rating);
        ...
        elseif ($voted && ($voted > 0) && ($vote_rating < 0)) { 
            $this->updown_voting_remove_vote($h, $post_id, $user_id, $voted, $vote_rating); // same function call as above!
        ...
        elseif ($vote_rating > 0) { 
            $this->updown_voting_vote_up($h, $post_id, $user_id, $user_ip, $voted, $vote_rating, $count_and_status, $updown_voting_settings);
        }

        // Vote down!
        elseif ($vote_rating < 0) { 
            $this->updown_voting_vote_down($h, $post_id, $user_id, $user_ip, $voted, $vote_rating, $count_and_status, $updown_voting_settings);
        }
