...
class Submit
{
    ...
    public function install_plugin($h)
    {
        ...
        if (!isset($submit_settings['allowable_tags'])) { $submit_settings['allowable_tags'] = "<b><i><u><a><span><br><blockquote><del>"; }
        ...
        if (!isset($submit_settings['required_tags'])) { $submit_settings['required_tags'] = 'checked'; } 
    ...
    public function admin_theme_index_top($h)
    {
        ...
        $h->vars['submission_closed'] = !$h->vars['submit_settings']['enabled'] ? true : false;
    }
...
// JRB
//error_log( "SUBMITTED DATA: " . var_dump( $submitted_data ));
